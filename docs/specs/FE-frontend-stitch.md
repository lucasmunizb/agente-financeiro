...
**E. Conta**
- [x] 17. Configurações & privacidade (perfil, fuso, vínculo, transparência de IA, exclusão LGPD) *(**gerada no Stitch**; ligação ao Blade/backend pendente)*
